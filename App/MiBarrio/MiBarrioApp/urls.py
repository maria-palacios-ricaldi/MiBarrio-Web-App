...
from MiBarrioApp.forms import MyPasswordResetForm
from .views import *
...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            ...
            form_class=MyPasswordResetForm,  # Specify custom form class here
            success_url=reverse_lazy('MiBarrioApp:password_reset_done')  # Updated success_url
        ),
        name='password_reset'
    ),
    #other web app pages
